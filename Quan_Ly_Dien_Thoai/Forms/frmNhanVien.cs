...
namespace Quan_Ly_Dien_Thoai.From
{
    public partial class frmNhanVien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            // insert dl
            string sqlInsert = "insert into NhanVien values('" + txtMaNV.Text + "', N'" + txtTen.Text + "', '" + cbGioiTinh.Text + "', N'" + theDate + "', N'" + txtDiaChi.Text + "', N'" + txtPhone.Text + "', N'" + txtMaCV.Text + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sqlUpdate = "update NhanVien set TenNhanVien = '" + txtMaNV.Text + "', N'" + txtTen.Text + "', '" + cbGioiTinh.Text + "', N'" + theDate + "', N'" + txtDiaChi.Text + "', N'" + txtPhone.Text + "', N'" + txtMaCV.Text;
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            exSheet.Range["H6"].Value = "Mã Chức Vụ";
